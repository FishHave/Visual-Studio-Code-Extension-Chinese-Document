...
您可以使用一个[时句](/9.%20参考/6.%20时句上下文.md)控制这些操作的可见
...
欢迎内容中链接受支持。按照惯例，一个独自成行的链接是一个按钮。每个欢迎内容同样可以包含一个[时句](/9.%20参考/6.%20时句上下文.md)。想要更多例子，参阅[内建Git扩展](https://github.com/microsoft/vscode/tree/main/extensions/git)
